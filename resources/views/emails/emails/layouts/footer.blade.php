		...
		<td style="border-top: 1px solid #444444; text-align:center;padding:20px 0 15px 0;" style="">
			<table width="200" border="0" cellspacing="0" cellpadding="0" align="center" >
				<tr>
                    ...
                    <td style="text-align: center;">                       
                        <a href="{{ Common::getWebsiteSettings()->twitter_link ?? '#' }}" style="display: inline-block; text-align: center;" target="_blank">
                            <img src="{{ URL::asset('admin/files/images/twitter-icon.png') }}" width="32" height="32" style="display: block;">
                        </a>                        
                    </td>
                    <td style="text-align: center;">                        
                    ...
                    {{-- <td style="text-align: center;">                        
                        <a href="#" style="display: inline-block; text-align: center;" target="_blank">
                            <img src="{{ URL::asset('admin/files/images/youtube-icon.png') }}" width="32" height="32" style="display: block;">
                        </a>                       
                    </td>                                   --}}
                </tr>
            </table>
