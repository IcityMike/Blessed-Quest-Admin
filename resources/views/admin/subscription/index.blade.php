        ...
        <div class="box-header">
            <div class="row">
                <div class="col-xs-6">
                 ...
                 <?php   if(Common::hasPermission(config('settings.admin_modules.subscription'),config('settings.permissions.create'))){ ?>
                <div class="col-xs-6">
                    <div class="pull-right">
           
                        <a class="btn custom-btn add-new-btn" href="{{ route('admin.subscription.create') }}"><i class="fa fa-plus"></i> Add New</a>
                    </div>                    
                </div>
                 <?php  } ?>
            </div>
...
<script>
  $(document).ready(function() {
    ...
    var url = "{{route('admin.subscription.list')}}";
