            ...
            <div class="shadow-box">
                <div class="box-header">
                    <div class="row">
                        ...
                        <?php   if(Common::hasPermission(config('settings.admin_modules.library'),config('settings.permissions.create'))){ ?>
                            <div class="col-xs-6">
                                <div class="pull-right">
                       
                                    <a class="btn custom-btn add-new-btn" href="{{ route('admin.library.create') }}"><i class="fa fa-plus"></i> Add New</a>
                                </div>                    
                            </div>
                        <?php  } ?>
                    </div>
...
$(document).ready(function() {
    var url = "{{route('admin.library.list')}}";
    ...
    $('body').on('click', '.inactive_button', function(e) {
        ...
        Swal.fire({
            title: 'Are you sure?',
            text: 'You are about to inactive library.',
            icon: 'warning',
    ...
    $('body').on('click', '.active_button', function(e) {
        ...
        Swal.fire({
            title: 'Are you sure?',
            text: 'You are about to activate library.',
            icon: 'warning',
            showCancelButton: true,
            confirmButtonColor: '#3085d6',
            cancelButtonColor: '#d33',
