...
class ProcessImage implements ShouldQueue
{
    ...
    public function __construct($sourceImg, $userid, $store_location_details)
    {
        $this->path = $sourceImg;

        $this->uid = $userid;

        $this->store_location_detailsId = $store_location_details->id;
    ...
    public function handle()
    {
        ...
        foreach ($this->path as $sourceImg) {
           ...
           if($sourceImg){
            ...
            'user_id' => @$this->uid,
            'source_details_id' => @$this->store_location_detailsId,
            'image' => @$sourceImg,
