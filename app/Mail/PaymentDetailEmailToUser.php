...
class PaymentDetailEmailToUser extends Mailable
{
    ...
    public function build()
    {
       ...
       // $subject = $data['siteTitle']." - ".config('settings.MonoovaNPPReturnEmailSubject');
        $emailTemplate = EmailTemplate::find(config('settings.email_template.payment_detail_email_to_user'));
        ...
        return $this->subject($subject)
                    ->view('emails.userPaymentDetailEmail', $data);
    }
