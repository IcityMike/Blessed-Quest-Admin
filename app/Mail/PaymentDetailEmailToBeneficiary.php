...
class PaymentDetailEmailToBeneficiary extends Mailable
{
    ...
    public function build()
    {
       ...
       // $subject = $data['siteTitle']." - ".config('settings.MonoovaNPPReturnEmailSubject');
        $emailTemplate = EmailTemplate::find(config('settings.email_template.payment_detail_email_to_Beneficiary'));
