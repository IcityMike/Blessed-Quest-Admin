...
class ClientSwiftWelcomeEmail extends Notification
{
    use Queueable;
    public $data;
    ...
    public function toMail($notifiable)
    {
       ...
       $emailTemplate = EmailTemplate::find(config('settings.email_template.client_swiftwelcome_email'));
       ...
       /*** Log email details to database ***/
        $logData = $data;
        $emailView = View('emails.welcomeSwiftUserEmail')->with( $logData);
       ...
       ->view(
           'emails.welcomeSwiftUserEmail', $data
       )
