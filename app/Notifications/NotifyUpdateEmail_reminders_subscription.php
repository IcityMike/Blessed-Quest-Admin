...
class NotifyUpdateEmail_reminders_subscription extends Notification
{
    use Queueable;
    public $user;
    public $userData;
    ...
    public function toMail($notifiable)
    {
       ...
       $emailTemplate = EmailTemplate::find(config('settings.email_template.email_notification_reminders_subscription'));
